...
class HeadOfDeliveryPolicySeeder 
{
    public static function create($projectId) {
        $project = Project::find($projectId); 
        $projectRoles = $project->projectRoles()->get(); 

        $projectRole = $projectRoles->where('name', 'Head of Delivery')->first(); 
        ...
        foreach($policyResources as $policyResource) {
            ...
            if($resource->name == 'STAKEHOLDER_REGISTER' && ($policy->name == 'VIEW')) {
                $projectRole->policyResources()->attach($policyResource, [
                    'is_permitted' => true
                ]);
            }
            ...
            if($resource->name == 'STAKEHOLDER_ANALYSIS' && ($policy->name == 'VIEW')) {
                $projectRole->policyResources()->attach($policyResource, [
                    'is_permitted' => true
                ]);
            }
            ...
            if($resource->name == 'ACTIVITY_COST_ESTIMATE' && ($policy->name == 'VIEW')) {
                $projectRole->policyResources()->attach($policyResource, [
                    'is_permitted' => true
                ]);
            }
            ...
            /*BUDGET*/
            if($resource->name == 'BUDGET' && ($policy->name == 'VIEW')) {
                $projectRole->policyResources()->attach($policyResource, [
                    'is_permitted' => true
                ]);
            }
            ...
            /*RISK_REGISTER*/
            if($resource->name == 'RISK_REGISTER' && ($policy->name == 'VIEW')) {
                $projectRole->policyResources()->attach($policyResource, [
                    'is_permitted' => true
                ]);
            }
            ...
            if($resource->name == 'STAKEHOLDER_ENGAGEMENT_ASSESSMENT' && ($policy->name == 'VIEW')) {
                $projectRole->policyResources()->attach($policyResource, [
                    'is_permitted' => true
                ]);
            }
